 ...
 * @version $Id$
 ...
 @author    Wuerth Phoenix / MOMI
 @copyright Copyright (c) 2010-2013 Datainjection plugin team
 @copyright Copyright (C) 2020 Wuerth Phoenix, http://www.wuerth-phoenix.com
 @license   GPLv2+
...
class PluginDatainjectionItem_DiskInjection extends Item_Disk //MOMI NE4: Item !!
   ...
   **/
   ...
   function processAfterInsertOrUpdate($values, $add=true, $rights=array()) {
	  ...
	  //error_log("TEST");  // prints to /var/opt/rh/rh-php71/log/php-fpm/www-error.log
	  //error_log(print_r($values, true));   //"true" needed to return the string!
      ...
      if (isset($values['Computer']['id'])) {
         ...
         $foreign = 'id'; //getForeignKeyFieldForTable(getTableForItemType(get_parent_class($this)));    MOMI: id!
		 $where   = [
		 ...
		 //TODO: probably now items_id is needed, commenting this line
         // $tmp['computers_id'] = $values['Computer']['id'];
         $tmp['name'] =  $values[get_parent_class($this)]['name'];
		 
		 //NE4 END
		 
		 //MOMI here "if" is useless! (probably this was copied from deviceprocessorinjection.class.php)
